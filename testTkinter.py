...
class Application(tkinter.Frame):
    ...
    def __init__(self,master):
        ...
        self.telnet_btn.grid(row=0,column=0,sticky=tkinter.NW)
        self.console_btn = tkinter.Button(self,text="串口",command=lambda:self.chg_console())
        self.console_btn.grid(row=0,column=1,sticky=tkinter.NW)
...
class TelnetInterface(tkinter.Frame):
    def __init__(self,parent):
        ...
        self.telnet_text.grid(row=3,column=0,sticky=tkinter.NW)
        self.ip_address = tkinter.Label(self,text="IP地址")
        self.ip_address.grid(row=4,column=0,sticky=tkinter.NW)
        #IP地址输入栏
        #打印回显栏
        #添加一些按钮
...
class ConsoleInterface(tkinter.Frame):
    def __init__(self,parent):
        ...
        self.console_text.grid(row=3,column=0,sticky=tkinter.NW)
        self.console_port = tkinter.Label(self,text="COM口")
        self.console_port.grid(row=4,column=0,sticky=tkinter.NW)
        #连接串口所需要的参数
